        ...
        <div className="card p-6 sm:p-8 page-enter">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {fields.map(({ name, label, icon: Icon, placeholder, type }) => (
              <div key={name}>
                ...
                <div className="relative">
                  <Icon className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none z-10" size={16} style={{ color: 'var(--text-muted)' }} />
                  <input type={type} name={name} value={form[name]} onChange={handleChange}
                    placeholder={placeholder} className="input" style={{ paddingLeft: '2.5rem' }} required />
                </div>
              </div>
            ))}
            ...
            <div>
              ...
              <div className="relative">
                <FiAtSign className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none z-10" size={16} style={{ color: 'var(--text-muted)' }} />
                <input type="text" name="username" value={form.username} onChange={handleChange}
                  placeholder="rahul_desi" className="input" style={{ paddingLeft: '2.5rem', paddingRight: '2.5rem' }}
                  required pattern="[a-z0-9_]{3,30}" />
              ...
              <p className="text-xs mt-1" style={{ color: 'var(--text-muted)' }}>Lowercase letters, numbers and _ only</p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" name="password" value={form.password} onChange={handleChange}
                  placeholder="Min 8 characters" className="input" style={{ paddingLeft: '2.5rem' }}
